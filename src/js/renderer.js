new Vue({
    ...
    methods: {
        ...
        openFileDialog(){
            electronAPI.openFile(this.audioExtArr.concat(this.videoExtArr))
            .then(filePaths=>{
        ...
        async openDirectory(dirType){
            ...
            if(dirType=="output"){
                ...
                var fileData = window.electronAPI.getFilesFromDir(dirPaths,this.audioExtArr.concat(this.videoExtArr));
        ...
        goConvert(){
            ...
            if(newFormatNoSettingData.length>0){
                this.$message.error(this.lang('newFormatNoSettingTip'));
                return;
            }
        ...
        convertStart(){
            for(var i=0;i<this.fileData.length;i++){
                ...
                ((j)=>{
                    ...
                    electronAPI.execFfmpeg(this.fileData[j].sourcePath, outputPath, {vn:this.videoExtArr.includes(sourceFormat)},(progress,output)=>{
